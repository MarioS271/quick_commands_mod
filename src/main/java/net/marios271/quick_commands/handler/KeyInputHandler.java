package net.marios271.quick_commands.handler;
...
public class KeyInputHandler {
    public static final KeyMapping.Category QUICK_COMMANDS_CATEGORY = KeyMapping.Category.register(Identifier.parse("quick_commands"));
